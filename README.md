...
A mock implementation of the Anthropic API for testing purposes. Stand
in for the real Anthropic API in test suites so you can exercise client
code without network access or API costs.

> **Note:** This is a base project scaffold — the mock implementation is
> not yet built out.
